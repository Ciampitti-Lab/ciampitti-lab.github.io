                        ...
                        <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-lg text-gray-600">
                            {project.authors.map((author: Author, index: number) => (
                                <span key={index} className="whitespace-nowrap">
                                    ...
                                    {index < project.authors.length - 1 && <span className="text-gray-400">,</span>}
                                </span>
                            ))}
                        </div>
            ...
            <div className="max-w-6xl mx-auto px-8 py-16">
                ...
                <section className="relative py-20 mb-20">
                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center max-w-7xl mx-auto px-8">
                        {/* Abstract Text */}
                        <div>
                            <h2 className="text-4xl font-bold mb-10 text-gray-900">Abstract</h2>
                            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                                <p>
                                    We introduce the first fully on-field pipeline that estimates maize-ear length, width and volume from a single RGB + depth capture and immediately forecasts grain yield per plant. A YOLOv12n-seg model isolates the ear in unconstrained lighting, a bespoke network (<em>EVNet</em>) regresses volume from the segmented point cloud, and gradient-boosted trees convert morphology into yield.
                                </p>
                                <p>
                                    On Kansas field data we reach <strong className="text-green-800 font-semibold">98.6% mAP@0.5 for segmentation, 28.9 ml RMSE for volume, and 13.9 g RMSE for yield (ideal) / 24.1 g (real)</strong>. The pipeline runs in ≈1 s per image, needs no destructive sampling, and the images, code, and trained weights are open-sourced.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center lg:justify-end">
                            <div className="relative">
                                ...
                                <div className="mt-6 text-center">
                                    <p className="text-lg font-medium text-gray-700">Real-time field deployment</p>
                                    <p className="text-sm text-gray-500">Maize ear detection & yield prediction</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="mb-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold mb-6 text-gray-900">Our Pipeline</h2>
                    </div>
                ...
                <section className="mb-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold mb-6 text-gray-900">Key Results</h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                            ...
                            <p className="text-gray-600 text-sm text-center mb-2">95.8% precision/recall</p>
                            <p className="text-green-600 font-bold text-center">mAP@0.5 = 98.6%</p>
                            <p className="text-gray-500 text-xs text-center mt-1">1.11s per image</p>
                        </div>
                        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                            <div className="text-3xl mb-4 text-center">📏</div>
                            <h3 className="text-lg font-semibold mb-2 text-center">Volume (Real-world)</h3>
                            <p className="text-blue-600 font-bold text-center">R² = 0.88</p>
                            <p className="text-gray-600 text-sm text-center">RMSE = 28.9 ml</p>
                        </div>
                        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                            <div className="text-3xl mb-4 text-center">🌽</div>
                            <h3 className="text-lg font-semibold mb-2 text-center">Yield (Ideal)</h3>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                            <div className="text-3xl mb-4 text-center">🌽</div>
                            <h3 className="text-lg font-semibold mb-2 text-center">Yield (Real-world)</h3>
                ...
                <section className="mb-20">
                    <div className="bg-gray-50 rounded-xl p-4 sm:p-8 max-w-none sm:max-w-4xl mx-auto">
                        <h2 className="text-2xl font-bold mb-6 text-center text-gray-900">Why it Matters</h2>
                        <div className="space-y-4">
                            <div className="flex items-start">
                                ...
                                <p className="text-gray-700"><strong>First non-destructive ear yield predictor</strong> deployable in the field.</p>
                            </div>
                            <div className="flex items-start">
                                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-4 mt-1 flex-shrink-0">
                                    <span className="text-white text-sm">✓</span>
                                </div>
                                <p className="text-gray-700"><strong>Open dataset & code</strong> (CornDepth) to accelerate follow-up work.</p>
                            </div>
                            <div className="flex items-start">
                                <div className="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center mr-4 mt-1 flex-shrink-0">
                                    <span className="text-white text-sm">✓</span>
                                </div>
                                <p className="text-gray-700"><strong>Bridges phenotyping & on-farm decision-making</strong> for breeders and agronomists.</p>
                            </div>
                        </div>
                    </div>
                </section>
  ...
  publisher={IEEE/CVF}
                ...
                <footer className="text-center py-8 border-t border-gray-200">
                    <p className="text-gray-600">
                        © 2025 Pedro Cisdeli, Gustavo Nocera Santiago, German Mandrini, Ignacio Ciampitti; Purdue University – Ciampitti Lab
                    </p>
                </footer>
            </div>
        </div>
