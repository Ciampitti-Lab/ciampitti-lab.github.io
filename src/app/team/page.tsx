            ...
            <div className="container-custom">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="text-lg text-purdue-secondary-gray2 max-w-3xl mx-auto">
                        Meet the researchers, scientists, and students working together to advance digital agriculture
                        and crop management systems at the Ciampitti Lab.
                    </p>
                </div>
                            ...
                            <div className="p-6 flex flex-col h-[calc(100%-16rem)]">
                                <div className="flex-grow">
                                    <div className="flex items-baseline justify-between mb-3">
                                        ...
                                        <span className="text-lg text-purdue-rush font-medium">{member.role}</span>
                                    </div>
                                    <p className="text-purdue-secondary-gray2">{member.research_info}</p>
                                </div>
                                {member.linkedin && (
                                    <a
